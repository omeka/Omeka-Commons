...
class Installations_InstallationItemType extends Omeka_Record
{
    public $id;
    public $orig_id;
    ...
    /**
     * Each installation will need to duplicate the 'core' Omeka ItemTypes for their
     ...
     *
     * Creates a new record for the Item Type in ItemTypeTable, and creates the InstallationItemType
     * to work with it.
     *
     * @param int $orig_id The original id in the installation. maps to core Omeka item types
